		...
		<div class="page-header">
			...
			<div class="ml-auto">
				<div class="input-group">
					<a href="<?php echo site_url('Master/personal_learning_list'); ?>" class="btn btn-info text-white btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Add New">
						<span>
							<i class="fa fa-eye"></i>&nbsp;Program Learning List
						</span>
					</a>&nbsp;&nbsp;
					...
					<div class="card-body">
						...
						<div class="form-group">
							<div class="row">	
								...
								<div class="col-lg-6 col-md-12">
									<label contenteditable="true" class="form-control">Type Of User</label>
						...
						<div class="form-group">
							<div class="row">	
								...
								<div class="col-lg-6 col-md-12">
									<label contenteditable="true" class="form-control">Personal Learning</label>
						...
						<div class="form-group">
							<div class="row">	
								<div class="col-lg-6 col-md-12">
									<label contenteditable="true" class="form-control">Improvement area</label>
								...
								<div class="col-lg-6 col-md-12">
									<label contenteditable="true" class="form-control">Suggestions for Program, Module, Venue</label>
						...
						<div class="form-group">
							<div class="row">	
								<div class="col-lg-6 col-md-12">
									<label contenteditable="true" class="form-control">Reviews for Facilitator / Co-facilitator</label>
								...
								<div class="col-lg-6 col-md-12">
									<label contenteditable="true" class="form-control">Any remark/ Note</label>
						...
						<div id="add_fields_form" style="display:none;">
							<form id="personal_learning_form" name="personal_learning_form" method="post" action="<?php echo base_url('master/personal_learning_form');?>">
	                           <?php //include('dynamic_field_generation.php');?>
...
<script type="text/javascript">
	$('#personal_learning_form').validate();
</script>