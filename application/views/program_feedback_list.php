...
<div class="container content-area">
	<div class="side-app">
		...
		<div class="page-header">
			<ol class="breadcrumb"><!-- breadcrumb -->
				...
				<li class="breadcrumb-item active" aria-current="page">Program Feedback List</li>
			</ol><!-- End breadcrumb -->
			<div class="ml-auto">
				<div class="input-group">
					<a href="<?php echo site_url('Master/program_feedback_form'); ?>" class="btn btn-secondary text-white btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Add New">
						<span>
							<i class="fa fa-plus"></i>&nbsp;Program Feedback
						</span>
					</a>
				</div>
			</div>
			...
			<div class="card-body">
				...
				<div class="table-responsive">
					<table id="example2" class="table table-striped table-bordered text-nowrap" >
						...
						<tbody>
						<?php 
							if($program_feedback_list){
								foreach($program_feedback_list as $program_feedback){
						?>
	...
	function deleteDynamicField(id){
		...
		if(res){
			var url="<?php echo site_url('master/delete_dynamic_field/'); ?>program_feedback_form/"+id+'/program_feedback_list';
	...
	function getDynamicFormFieldData(id){
		$.ajax({
			...
			data:'tablename=program_feedback_form&id='+id,
