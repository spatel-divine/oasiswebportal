	...
	<div class="side-app">
		...
		<div class="page-header">
			<ol class="breadcrumb"><!-- breadcrumb -->
				...
				<li class="breadcrumb-item active" aria-current="page">View Share Post</li>
			</ol><!-- End breadcrumb -->
			<div class="ml-auto">
						...
						<div class="form-group">
							<div class="row">				
								<div class="col-lg-6 col-md-12">
									...
									<input type="text" class="form-control" id="posttitle" name="posttitle" value="<?php if(isset($share_post->posttitle) && $share_post->posttitle!='' && $share_post->posttitle!=null){ echo $share_post->posttitle; }else{ echo 'N/A'; } ?>" readonly>	
								</div>
								<div class="col-lg-6 col-md-12">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-lg-12 col-md-12">
									...
									<textarea id="post_description" name="post_description" class="form-control" readonly><?php if(isset($share_post->post_description) && $share_post->post_description!='' && $share_post->post_description!=null){ echo $share_post->post_description; }else{ echo 'N/A'; } ?></textarea>
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="row">
								<div class="col-lg-8 col-md-12">
									...
									<p><?php if(isset($share_post->featured_image) && $share_post->featured_image!='' && $share_post->featured_image!=null){ 
										$filepath=base_url().'upload/featured_images/'.$share_post->featured_image;
											if(file_exists('upload/featured_images/'.$share_post->featured_image)){ ?>
