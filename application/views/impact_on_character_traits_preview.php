					...
					<div class="card-body">
						...
						<div class="form-group">
							<div class="row">	
								...
								<div class="col-lg-6 col-md-12">
									<label>Occupation (School/College/Profession)</label>
						...
						<div class="form-group">
							<div class="row">	
								<div class="col-lg-4 col-md-12">
									<label>Which first program did you attend at Oasis</label>
								...
								<div class="col-lg-4 col-md-12">
									<label>Total number of Oasis programs attended so far</label>
						...
						<div class="form-group">
							<div class="row">	
								<div class="col-lg-12 col-md-12">
									<label>Give Details of Programs</label>
										...
										<table class="table table-striped table-bordered text-center" >
											...
											<tbody>
												...
												<tr>
													...
													<td><input type="text" class="form-control" name="learning_status" value="<?php echo set_value('learning_status');?>" placeholder="Status at present"></td>
												</tr>
												<tr>
